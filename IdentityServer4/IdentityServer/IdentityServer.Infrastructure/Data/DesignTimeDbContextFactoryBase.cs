...
namespace IdentityServer.Infrastructure.Data
{
    ...
    {
        private const string MIGRATION_ASSEMBLY = "IdentityServer.Infrastructure";
        ...
        private TContext Create(string connectionString)
        {
            ...
            optionsBuilder.UseSqlServer(connectionString, sqlOptions => sqlOptions.MigrationsAssembly(MIGRATION_ASSEMBLY));
